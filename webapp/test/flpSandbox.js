		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[MM] 월 수불부",
									"targetURL": "#comdinemmzmm0003-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdinemmzmm0003-display": {
								"semanticObject": "comdinemmzmm0003",
								"action": "display",
								"description": "[MM] 월 수불부 플랜트별 조회",
								"title": "[MM] 월 수불부",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.dine.mm.zmm0003",
									"url": sap.ui.require.toUrl("com/dine/mm/zmm0003")
								}
							}
						}
					}
